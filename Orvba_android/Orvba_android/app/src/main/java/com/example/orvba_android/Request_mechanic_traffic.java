...
public class Request_mechanic_traffic extends AppCompatActivity {
    EditText e1,e2,e3;
    Button b1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_request_mechanic_traffic);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (request.equalsIgnoreCase("")) {
                    ...
                    RequestQueue queue = Volley.newRequestQueue(Request_mechanic_traffic.this);
