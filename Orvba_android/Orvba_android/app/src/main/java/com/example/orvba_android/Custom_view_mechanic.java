...
public class Custom_view_mechanic extends BaseAdapter{
    ...
    public Custom_view_mechanic(Context applicationContext, ArrayList<String> a, ArrayList<String> b, ArrayList<String> c) {
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_custom_view_mechanic, null);
        ...
        tv4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i=new Intent(context,Request_mechanic.class);
                context.startActivity(i);
                SharedPreferences sh=PreferenceManager.getDefaultSharedPreferences(context);
                SharedPreferences.Editor ed=sh.edit();
                ed.putString("mid",View_mechanic.mid.get(position));
                ed.commit();
