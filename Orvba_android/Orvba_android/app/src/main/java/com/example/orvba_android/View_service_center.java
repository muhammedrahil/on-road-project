...
public class View_service_center extends AppCompatActivity{
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RequestQueue queue = Volley.newRequestQueue(View_service_center.this);
...
//                    Toast.makeText(View_service_center.this, ""+LocactionService.lati+","+LocactionService.logi, Toast.LENGTH_SHORT).show();
                    lv.setAdapter(new Custom_view_service_center(View_service_center.this, Name,Phone,Email,sid));
                } catch (Exception e) {
                    Toast.makeText(View_service_center.this, ""+e, Toast.LENGTH_SHORT).show();
                    Log.d("=========", e.toString());
                }
            }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(View_service_center.this, "err" + error, Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
