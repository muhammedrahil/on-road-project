...
public class Feedback_traffic extends AppCompatActivity {
    EditText e1;
    Button b1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_feedback_traffic);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(Feedback_traffic.this, ""+feedback, Toast.LENGTH_SHORT).show();

                if (feedback.equalsIgnoreCase("")) {
                    e1.setError("Enter feedback");
                } else {

                    RequestQueue queue = Volley.newRequestQueue(Feedback_traffic.this);
