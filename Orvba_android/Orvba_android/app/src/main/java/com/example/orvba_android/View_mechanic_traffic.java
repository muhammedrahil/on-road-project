...
public class View_mechanic_traffic extends AppCompatActivity{
    ListView lv;
    SharedPreferences sp;
    String url = "", ip = "";
    public static ArrayList<String> Name, Phone, Gender, mid;
    Intent ik;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_view_mechanic_traffic);
...
//        Toast.makeText(this, "hy", Toast.LENGTH_SHORT).show();
        RequestQueue queue = Volley.newRequestQueue(View_mechanic_traffic.this);
...
//                        Toast.makeText(View_mechanic.this, ""+mid, Toast.LENGTH_SHORT).show();
                    ...
                    lv.setAdapter(new Custom_mechanic_traffic(View_mechanic_traffic.this, Name, Phone,mid));
                } catch (Exception e) {
                    Log.d("=========", e.toString());
                }
            }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(View_mechanic_traffic.this, "err" + error, Toast.LENGTH_SHORT).show();
            }
        });
