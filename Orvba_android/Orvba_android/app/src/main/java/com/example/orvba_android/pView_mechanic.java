...
public class pView_mechanic extends AppCompatActivity{
    ListView lv;
   ...
   public static  ArrayList<String> Name, Phone,  mid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pview_mechanic);
...
//        Toast.makeText(this, "hy", Toast.LENGTH_SHORT).show();
        RequestQueue queue = Volley.newRequestQueue(pView_mechanic.this);
...
//                        Toast.makeText(View_mechanic.this, ""+mid, Toast.LENGTH_SHORT).show();
                    ...
                    lv.setAdapter(new pCustom_view_mechanic(pView_mechanic.this, Name, Phone,mid));
                } catch (Exception e) {
                    Log.d("=========", e.toString());
                }
            }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(pView_mechanic.this, "err" + error, Toast.LENGTH_SHORT).show();
            }
        });
